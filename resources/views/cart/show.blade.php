...
<section class="design-process-section" id="process-tab">
            ...
            <div class="col-md-6">
              <div class="box">
                <div class="d-flex flex-row align-content-center justify-content-around text-center">
                  ...
                  <div class="p-2"><h4>Total Amal</h4><h2>Rp. {{number_format(App\Helpers\CartHelper::getJumlahAmalTersalurkan(), 0,',','.')}}</h2><a href="{{route('umum.program.amalall')}}" class="btn btn-custom w-100">Tambah Amal</a><br>&nbsp;</div>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="box">
                <div class="d-flex flex-row align-content-center justify-content-around text-center">
                  ...
                  <div class="p-2"><h4>Total Zakat</h4><h2>Rp. {{number_format(App\Helpers\CartHelper::getJumlahZakatTersalurkan(), 0,',','.')}}</h2><a href="{{route('umum.program.zakatall')}}" class="btn btn-custom w-100">Tambah Zakat</a><br>Wajib Zakat <b>Rp. {{number_format(App\Helpers\CartHelper::getJumlahWajibZakat(), 0,',','.')}}</b></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <br>
            ...
            <h3 class="font-weight-bold text-center">Rp. {{number_format(App\Helpers\CartHelper::getJumlahTersalurkan(), 0,',','.')}}</h3><br>
            <div class="d-flex flex-wrap">
              <div class="ml-auto p-2">
                <div class="p-2">
                  @if (App\Helpers\CartHelper::getJumlahTersalurkan() != 0)
  ...
  <div class="myAlert-zakat-kurant alert alert-danger">
      ...
      <strong>Perhatian!</strong> Mohon tambahkan program zakat untuk menunaikan zakat sisa zakat anda sebesar Rp.{{number_format(App\Helpers\CartHelper::getJumlahWajibZakat() - App\Helpers\CartHelper::getJumlahZakatTersalurkan(), 0,',','.')}}
    </div>
...
<script>
  ...
  $('[data-toggle="tooltip"]').tooltip()
      ...
      $('#btnselanjutnya').click(function(e) {
       @if( App\Helpers\CartHelper::getJumlahWajibZakat() - App\Helpers\CartHelper::getJumlahZakatTersalurkan() != 0)
       e.preventDefault();
